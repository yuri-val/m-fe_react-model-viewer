...
export class Holdable extends Component {
    ...
    render() {
        return (React.createElement("div", { className: `${this.props.className}`, onTouchStart: this.onMouseDown, onTouchEnd: this.onMouseOut, onMouseOut: this.onMouseOut, onMouseDown: this.onMouseDown, onMouseUp: this.onMouseOut, onClick: this.props.onPress }, this.props.children));
    }
}
