...
import { D3ModelTypes, } from '../../../types';
import { inflate, unzip } from '../compressor';
/** 根据模型名称推导出可能的类型 */
export function getModelType(fileName, model) {
...
/** 根据模型名称推导出可能的压缩类型 */
export function getModelCompressType(fileName, model) {
    const name = (model instanceof File ? model.name : model) || fileName || '';
...
/** 将模型统一转化为文件对象 */
export async function getFileObjFromModelSrc(props) {
