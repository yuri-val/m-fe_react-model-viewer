...
/** 暴力搜索计算壁厚 */
export function calcWallThicknessByViolence(mesh) {
    ...
    for (const i of faceIndexList) {
        ...
        const thisWallThickness = get(intersects, intersects => intersects[intersects.length > 1 ? 1 : 0].distance, Number.MAX_VALUE);
