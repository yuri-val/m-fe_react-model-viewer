...
class OrbitControlsGizmo {
    constructor(orbitControls, options) {
        ...
        const invRotMat = new three_1.Matrix4();
        const mouse = new three_1.Vector3();
        const rotateStart = new three_1.Vector2();
        const rotateEnd = new three_1.Vector2();
        const rotateDelta = new three_1.Vector2();
        const center = new three_1.Vector3(options.size / 2, options.size / 2, 0);
        ...
        function createAxes() {
            ...
            return [
                {
                    axis: 'x',
                    direction: new three_1.Vector3(1, 0, 0),
                    size: size.primary,
                    color: colors.x,
                    line,
                    label: 'X',
                ...
                {
                    axis: 'y',
                    direction: new three_1.Vector3(0, 1, 0),
                    size: size.primary,
                    color: colors.y,
                    line,
                    label: 'Y',
                ...
                {
                    axis: 'z',
                    direction: new three_1.Vector3(0, 0, 1),
                    size: size.primary,
                    color: colors.z,
                    line,
                    label: 'Z',
...
//# sourceMappingURL=OrbitControlsGizmo.js.map