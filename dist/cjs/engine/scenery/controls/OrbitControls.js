...
class OrbitControls extends THREE.EventDispatcher {
    constructor(camera, domElement, { domWindow, onUpdate, } = {}) {
        super();
        this.camera = camera;
    ...
    pan(deltaX, deltaY) {
        ...
        if (this._checkPerspectiveCamera(this.camera)) {
            ...
            // orthographic
            this.panLeft((deltaX * (this.camera.right - this.camera.left)) /
                this.camera.zoom /
                element.clientWidth, this.camera.matrix);
            this.panUp((deltaY * (this.camera.top - this.camera.bottom)) /
                this.camera.zoom /
                element.clientHeight, this.camera.matrix);
        }
        else {
    ...
    saveState() {
        ...
        if (this._checkOrthographicCamera(this.camera) ||
